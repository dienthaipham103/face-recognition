...
def predict(img_path, knn_clf=None, model_path=None, distance_threshold=0.4):
    ...
    # test the structure of closest_distance
...
if __name__ == "__main__":
    ...
    classifier = train('train', model_save_path='model.p', n_neighbors=10)
    print("Training complete!")

    # STEP 2: Using the trained classifier, make predictions for unknown images
    for image_file in os.listdir('photos'):
        full_file_path = os.path.join('photos', image_file)

        print("Looking for faces in {}".format(image_file))

        # Find all people in the image using a trained classifier model
        # Note: You can pass in either a classifier file name or a classifier model instance
        predictions = predict(full_file_path, model_path='model.p')
